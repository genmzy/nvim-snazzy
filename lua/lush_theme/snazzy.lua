...
local theme = lush(function(injected_functions)
	...
	return {
		...
		Character { fg = "#e2e4e5" },
		ColorColumn { sp = snazzy.statusline.bg, bg = "#282a36" },
		...
		NormalFloat { fg = snazzy.fg, bg = snazzy.dark },
		...
		sym("@character") { fg = snazzy.lavender },
		sym("@character.special") { SpecialChar },
		sym("@comment") { gui = "italic", fg = "#606580" },
		sym("@comment.danger") { fg = snazzy.pink },
		sym("@comment.note") { SpecialComment },
		sym("@comment.todo") { fg = snazzy.cyan },
		sym("@comment.warning") { fg = snazzy.pink },
		sym("@constant") { fg = snazzy.yellow },
		sym("@constant.builtin") { fg = snazzy.yellow },
		sym("@constant.macro") { fg = snazzy.pink },
		sym("@constructor") { fg = snazzy.blue },
		sym("@definition") { sp = snazzy.statusline.bg, bg = "#282a36" },
		sym("@definition.usage") { sp = snazzy.statusline.bg, bg = "#282a36" },
		...
		sym("@variable") { fg = snazzy.fg },
		sym("@variable.builtin") { fg = snazzy.lavender },
		sym("@variable.member") { fg = snazzy.cyan },
		sym("@variable.parameter") { fg = snazzy.fg },
		sym("@lsp.type.string") { sym("@none") },
		sym("@namespace.builtin") { fg = snazzy.lavender },
		...
		sym("@markup.raw.markdown_inline") { bg = "#282a36" },
		...
		Cursor { gui = "reverse" },
		CursorColumn { sp = snazzy.statusline.bg, bg = "#282a36", fg = "#e2e4e5" },
		CursorLine { bg = snazzy.cursorline },
		CursorLineFold { bg = "#303340", gui = "italic", fg = snazzy.blue },
		CursorLineNr { bg = snazzy.ui_9, fg = snazzy.yellow },
		...
		LspDefinition { sp = snazzy.statusline.bg, bg = "#282a36", fg = snazzy.blue },
		...
		LspReferenceRead { bg = "#3a3d4d" },
		LspReferenceText { bg = "#3a3d4d" },
		LspReferenceWrite { bg = "#3a3d4d" },
		...
		-- NotifyWARNBorder                                                                                          { fg=snazzy.pink, },
		-- NotifyWARNIcon                                                                                            { fg=snazzy.pink, },
		-- NotifyWARNTitle                                                                                           { fg=snazzy.pink, },
		...
		SnapSelect { sp = snazzy.statusline.bg, bg = "#282a36" },
		...
		TabLine { bg = snazzy.overlay },
		TabLineFill { sp = snazzy.statusline.bg, fg = "#192224", bg = "#282a36", gui = "bold" },
		TabLineSel { bg = snazzy.black, gui = "bold" },
		...
		TodoBgFIX { bg = snazzy.red, fg = "#1e1f29", gui = "bold" },
		TodoBgHACK { bg = snazzy.yellow, fg = "#1e1f29", gui = "bold" },
		TodoBgNOTE { bg = snazzy.green, fg = "#1e1f29", gui = "bold" },
		TodoBgPERF { bg = snazzy.cyan, fg = "#1e1f29", gui = "bold" },
		TodoBgTODO { bg = snazzy.cyan, fg = "#1e1f29", gui = "bold" },
		TodoBgWARN { bg = snazzy.yellow, fg = "#1e1f29", gui = "bold" },
		...
		debugBreakpoint { bg = snazzy.red, fg = "#1e1f29" },
		...
		CmpItemAbbrMatch { fg = snazzy.cyan },
		...
		BlinkCmpMenuBorder { fg = snazzy.lavender },
		...
		BlinkCmpKindOperator { fg = snazzy.pink },
