...
local theme = lush(function(injected_functions)
	...
	return {
		...
		Substitute { bg = snazzy.yellow.mix(snazzy.bg, 50), fg = snazzy.bg },
		...
		sym("@character") { fg = snazzy.yellow },
		...
		sym("@constant.builtin") { fg = snazzy.red },
		...
		sym("@diff.delta") { fg = snazzy.yellow, bg = snazzy.diff.change },
		sym("@diff.minus") { fg = snazzy.red, bg = snazzy.diff.delete },
		sym("@diff.plus") { fg = snazzy.green, bg = snazzy.diff.add },
		sym("@error") { fg = snazzy.red },
		sym("@function") { fg = snazzy.blue },
		sym("@function.builtin") { fg = snazzy.red },
		...
		sym("@keyword.function") { fg = snazzy.magenta },
		sym("@keyword.import") { fg = snazzy.magenta },
		sym("@keyword.operator") { fg = snazzy.magenta },
		sym("@keyword.repeat") { fg = snazzy.magenta },
		sym("@keyword.return") { fg = snazzy.magenta },
		sym("@keyword.storage") { fg = snazzy.magenta },
		sym("@label") { fg = snazzy.yellow },
		...
		sym("@variable.builtin") { fg = snazzy.orange },
		...
		DiffviewDiffAddAsDelete { bg = snazzy.diff.delete, fg = snazzy.red },
