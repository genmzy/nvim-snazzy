...
local theme = lush(function(injected_functions)
	...
	return {
		...
		Operator { fg = snazzy.magenta }, -- Operator       xxx cterm=bold gui=bold guifg=#ff6ac1
		Pmenu { sp = snazzy.statusline.bg, fg = snazzy.base8 }, -- Pmenu          xxx guifg=#eff0eb guibg=#3a3d4d guisp=#3a3d4d
		PmenuSbar { sp = "#848688", bg = "#848688", fg = "#f9f9f9" }, -- PmenuSbar      xxx guifg=#f9f9f9 guibg=#848688 guisp=#848688
		PmenuSel { sp = snazzy.statusline.bg, bg = "#3a3d4d" }, -- PmenuSel       xxx guifg=#5af78e guibg=#3a3d4d guisp=#3a3d4d
		...
		PmenuThumb { bg = snazzy.cyan }, -- PmenuThumb     xxx guibg=#a1a6a8 guisp=#a1a6a8
		...
		-- VisualNOS { sp = snazzy.ui_7, bg = snazzy.ui_7 }, -- VisualNOS      xxx guibg=#273d57 guisp=#273d57
		Visual { bg = "#3a3d4d" }, -- Visual         xxx guibg=#273d57 guisp=#273d57
		VisualNOS { bg = "#3a3d4d" }, -- VisualNOS      xxx guibg=#273d57 guisp=#273d57
		WarningMsg { fg = snazzy.orange }, -- WarningMsg     xxx cterm=bold gui=bold guifg=#ff9f43
		...
		TSQueryLinterError { fg = snazzy.red }, -- TSQueryLinterError xxx cterm=bold gui=bold guifg=#ff5c57

		sym("@none") {}, -- TSNone         xxx cterm= gui=

		sym("@annotation") { fg = snazzy.blue }, -- TSAnnotation   xxx cterm=italic gui=italic guifg=#57c7ff
		sym("@attribute") { fg = snazzy.blue }, -- TSAttribute    xxx cterm=italic gui=italic guifg=#57c7ff
		sym("@boolean") { fg = snazzy.purple }, -- TSBoolean      xxx cterm=italic gui=italic guifg=#a39df9
		...
		sym("@comment.danger") { fg = snazzy.orange }, -- TSDanger       xxx cterm=bold gui=bold guifg=#ff9f43
		...
		sym("@constant") { fg = snazzy.yellow }, -- TSConstant     xxx cterm=italic gui=italic guifg=#f3f99d
		sym("@constant.builtin") { fg = snazzy.red }, -- TSConstBuiltin xxx cterm=italic gui=italic guifg=#ff6ac1
		sym("@constant.macro") { fg = snazzy.orange }, -- TSConstMacro   xxx cterm=italic gui=italic guifg=#ff9f43
		...
		sym("@function.method.call") { fg = snazzy.blue }, -- TSMethodCall   xxx cterm=bold gui=bold guifg=#57c7ff
		sym("@include") { fg = snazzy.magenta }, -- TSInclude      xxx guifg=#ff6ac1
		sym("@keyword") { fg = snazzy.magenta }, -- TSKeyword      xxx cterm=bold gui=bold guifg=#ff6ac1
		sym("@keyword.conditional") { fg = snazzy.magenta }, -- TSConditional  xxx cterm=bold gui=bold guifg=#f3f99d
		sym("@keyword.coroutine") { fg = snazzy.magenta }, -- TSKeywordReturn xxx cterm=bold gui=bold guifg=#ff6ac1
		...
		sym("@keyword.function") { fg = snazzy.magenta }, -- TSKeywordFunction xxx cterm=bold gui=bold guifg=#ff6ac1
		sym("@keyword.import") { fg = snazzy.magenta }, -- TSKeyword      xxx cterm=bold gui=bold guifg=#ff6ac1
		sym("@keyword.operator") { fg = snazzy.magenta }, -- TSKeywordOperator xxx cterm=bold gui=bold guifg=#ff6ac1
		...
		sym("@label") { fg = snazzy.yellow }, -- TSLabel        xxx guifg=#5af78e
		...
		sym("@structure") { fg = snazzy.orange }, -- TSStructure    xxx cterm=italic gui=italic guifg=#ff9f43
		...
		DiffviewFilePanelCounter { fg = snazzy.cyan }, -- DiffviewFilePanelCounter xxx cterm=bold gui=bold guifg=#9aedfe
		...
		DiffviewFilePanelTitle { fg = snazzy.yellow }, -- DiffviewFilePanelRootPath xxx links to DiffviewFilePanelTitle
		...
		Directory { fg = snazzy.cyan }, -- Directory      xxx cterm=bold gui=bold guifg=#9aedfe
		DiffviewFolderName { Directory }, -- DiffviewFolderName xxx links to Directory
		Error { fg = snazzy.red }, -- Error          xxx guifg=#ff5c57
		ErrorMsg { fg = snazzy.red }, -- ErrorMsg       xxx cterm=bold gui=bold guifg=#ff5c57
		...
		FloatBorder { fg = snazzy.cyan }, -- FloatBorder    xxx guifg=#57c7ff
		...
		Function { fg = snazzy.purple }, -- Function       xxx cterm=bold gui=bold guifg=#a39df9
		...
		HopNextKey { fg = snazzy.hop.next_key }, -- HopNextKey     xxx cterm=bold gui=bold guifg=#ff007c
		HopNextKey1 { fg = snazzy.hop.next_key1 }, -- HopNextKey1    xxx cterm=bold gui=bold guifg=#00dfff
		HopNextKey2 { fg = snazzy.hop.next_key2 }, -- HopNextKey2    xxx guifg=#2b8db3
		HopPreview { fg = "#b8bb26" }, -- HopPreview     xxx cterm=bold gui=bold guifg=#b8bb26
		...
		FlashLabel { fg = "#ff007c" }, -- LeapLabelSecondary xxx cterm=bold gui=bold guifg=#00dfff
		...
		LspFunction { fg = snazzy.blue }, -- LspFunction    xxx cterm=bold gui=bold guifg=#57c7ff
		...
		LspKeyword { fg = snazzy.magenta }, -- LspKeyword     xxx cterm=bold gui=bold guifg=#ff6ac1
		LspMethod { fg = snazzy.blue }, -- LspMethod      xxx cterm=bold gui=bold guifg=#57c7ff
		...
		MatchParen { fg = snazzy.green }, -- MatchParen     xxx cterm=bold gui=bold guifg=#5af78e
		...
		MoreMsg { fg = snazzy.yellow }, -- MoreMsg        xxx cterm=bold gui=bold guifg=#f3f99d
		...
		NeotestMarked { fg = snazzy.orange }, -- NeotestMarked  xxx ctermfg=130 gui=bold guifg=#f79000
		...
		NeotestWinSelect { fg = "#00f1f5" }, -- NeotestWinSelect xxx ctermfg=14 gui=bold guifg=#00f1f5
		...
		NvimTreeExecFile { fg = snazzy.green }, -- NvimTreeExecFile xxx gui=bold guifg=#5af78e
		...
		NvimTreeImageFile { fg = snazzy.magenta }, -- NvimTreeImageFile xxx gui=bold guifg=#ff6ac1
		NvimTreeIndentMarker { fg = "#8094b4" }, -- NvimTreeIndentMarker xxx guifg=#8094b4
		NvimTreeLiveFilterPrefix { fg = snazzy.magenta }, -- NvimTreeLiveFilterPrefix xxx gui=bold guifg=#ff6ac1
		...
		NvimTreeOpenedFile { fg = snazzy.green }, -- NvimTreeOpenedFile xxx gui=bold guifg=#5af78e
		...
		NvimTreeSymlink { fg = snazzy.cyan }, -- NvimTreeSymlink xxx gui=bold guifg=#9aedfe
		NvimTreeVertSplit { VertSplit }, -- NvimTreeVertSplit xxx links to VertSplit
		NvimTreeWindowPicker { bg = "#4493c8", fg = "#ededed" }, -- NvimTreeWindowPicker xxx gui=bold guifg=#ededed guibg=#4493c8
		DiffviewFolderSign { PreProc }, -- DiffviewFolderSign xxx links to PreProc
		Question { fg = snazzy.yellow }, -- Question       xxx guifg=#f3f99d
		QuickFixLine { fg = snazzy.magenta }, -- QuickFixLine   xxx cterm=bold gui=bold guifg=#ff6ac1
		...
		SnapPosition { fg = snazzy.yellow }, -- SnapPosition   xxx cterm=bold gui=bold guifg=#f3f99d
		...
		luaTSConstructor { fg = "#f1f1f0" }, -- luaTSConstructor xxx cterm=bold gui=bold guifg=#f1f1f0
		luaTSPunctBracket { fg = "#f1f1f0" }, -- luaTSPunctBracket xxx cterm=bold gui=bold guifg=#f1f1f0
		...
		vimCommentTitle { fg = "#686868" }, -- vimCommentTitle xxx cterm=bold gui=bold guifg=#686868
		vimFuncName { fg = snazzy.yellow }, -- vimFuncName    xxx cterm=bold gui=bold guifg=#f3f99d
		vimFunction { fg = snazzy.magenta }, -- vimFunction    xxx cterm=bold gui=bold guifg=#ff6ac1
		vimIsCommand { fg = "#eff0eb" }, -- vimIsCommand   xxx guifg=#eff0eb
		vimLet { fg = snazzy.yellow }, -- vimLet         xxx guifg=#f3f99d
		vimNotFunc { fg = "#686868" }, -- vimNotFunc     xxx cterm=bold gui=bold guifg=#686868
		vimUserFunc { fg = snazzy.yellow }, -- vimUserFunc    xxx cterm=bold gui=bold guifg=#f3f99d
		...
		CmpCompletionWindowBorder { fg = snazzy.cyan }, -- CmpCompletionWindowBorder xxx guifg=#57c7ff
		CmpDocumentationWindowBorder { fg = snazzy.cyan }, -- CmpDocumentationWindowBorder xxx guifg=#57c7ff
